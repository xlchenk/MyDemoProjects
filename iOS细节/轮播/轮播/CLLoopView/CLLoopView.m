...
@property(nonatomic,strong) CLTimer *clTimer;
@end
...
- (UICollectionView *)collectionView{
    if (!_collectionView) {
        ...
        [_collectionView registerClass:[CLCycleViewCell class] forCellWithReuseIdentifier:cellIdentifier];
    }
...
- (void)setupTimer{
    self.clTimer = [[CLTimer alloc]initWithTimerInterval:1 target:self selector:@selector(fire)];
...
//    CGFloat currentOffset = self.collectionView.contentOffset.x;
    NSInteger page =self.collectionView.contentOffset.x/K_WIDTH;
    NSInteger currentPageIndex = page%_imageArray.count;
